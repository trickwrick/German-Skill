export const a2CourseContent = {
  ...
  objectivesLeft: [
    "Become competent in German A2 level",
    "Strengthen grammar, vocabulary, and speaking skills",
    "Practice real-life German conversations",
    "Gain confidence for official certification exams",
    "Learn with structured lessons and expert guidance",
  ...
  objectivesRight: [
    ...
    "Understand German culture and communication styles",
    "Track progress with quizzes and practice tests",
    "Get lifetime access to course materials",
  ],
  courseDescription: [
    "Learn German A2 with experienced native trainers at GermanSkill.",
  ...
  goalsLessons: [
    "Become fully competent in German A2 level",
  ...
  curriculumSections: [
    {
      ...
      topics: [
        ...
        "Cases, tenses, and conjunctions",
        "Practical exercises and practice drills",
      ],
    },
    {
    ...
    },
    {
      ...
      topics: [
        ...
        "Flashcards and vocabulary tests",
      ],
    },
    {
      title: "Other",
  ...
  faqs: [
    {
      q: "What prior knowledge do I need for German A2?",
      a: "You should have completed German A1 level or have equivalent beginner knowledge before joining this course.",
    },
    {
    ...
    {
      q: "Is this course suitable for Goethe A2 exam preparation?",
      a: "Yes. The course includes preparation support for speaking, writing, and core skills required at A2 level.",
    },
  ],
  reviewsSummary: {
    average: "4.50",
  ...
  reviews: [
    ...
    },
    {
      ...
      date: "May 18, 2023",
      rating: 4,
      text: "I highly recommend GermanSkill as one of the best language institutes for learning German in Jaipur.",
      color: "#f59e0b",
    },
    {
      initials: "GS",
