...
export const defaultTermsContent: LegalPageContentData = {
  html: legalParagraphsToHtml([
    ...
    "For questions about these terms, contact us at fluentauf@gmail.com or +91 79765 92299.",
  ]),
};
...
export const defaultRefundContent: LegalPageContentData = {
  html: legalParagraphsToHtml([
    ...
    "For refund-related questions, email fluentauf@gmail.com or call +91 79765 92299 before enrolling.",
  ]),
};
