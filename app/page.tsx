...
function CareersSection() {
  return (
    <section className="careers-section" style={{ padding: '1.5rem 1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '6px 16px', borderRadius: '9999px', border: '1px solid rgba(255,255,255,0.2)', marginBottom: '1rem' }}>
      ...
      <h2 style={{ color: 'white', fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: '700', marginBottom: '0.75rem', marginTop: 0, maxWidth: '800px', lineHeight: '1.2' }}>
        Join more than 1 million<br />learners worldwide
      </h2>
      <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '1.1rem', margin: 0, maxWidth: '700px', lineHeight: '1.6' }}>
